...
library ShambaDONSelector {
    ...
    {
        if (DON_number == 1) {
            string[] memory dataStreamsList = new string[](2);
            dataStreamsList[0] = "temperature_new-delhi";
            dataStreamsList[1] = "fire_riverside";
            return dataStreamsList;
        } else if (DON_number == 2) {
            string[] memory dataStreamsList = new string[](1);
            dataStreamsList[0] = "temperature_nairobi";
            return dataStreamsList;
        } else if (DON_number == 3) {
            string[] memory dataStreamsList = new string[](1);
            dataStreamsList[0] = "air-quality_new-delhi";
            return dataStreamsList;
        } else {
            string[] memory dataStreamsList = new string[](0);
            return dataStreamsList;
        }
    }
